...
public class CreateUserRequestValidator : AbstractValidator<CreateUserRequestDto>
{
    public CreateUserRequestValidator()
    {
        ...
        RuleFor(x => x.Role).NotEmpty().Must(r => r is "Admin" or "Manager" or "Cashier" or "Inventory" or "Supervisor").WithMessage("Role must be Admin, Manager, Cashier, Inventory, or Supervisor");
